 ...
 * Reason: Subject inherit Lecturer, sedangkan Subject itu bukan Lecturer
 * Solution: Use Composition
 * 
 * Smell Code: Deficient Encapsulation
 * Reason: Adanya private atribut dan setter
 * Solution: Remove Setter
 * 
 * Smell Code: Leaky Encapsulation
 * Reason: Adanya displaySubject() dan getter
 * Solution: Move Method
 * 
 * Smell Code: Broken Hierarchy
 * Reason: Subject inherit Lecturer, sedangkan Subject itu bukan Lecturer
 * Solution: Remove inheritance
 * 
 * Smell Code: Unutilized Abstraction
 * Reason: Terdapat kode yang di comment atau function main yang tidak digunakan
 * Solution: Remove Dead Code, Clean Up Comments
 */
